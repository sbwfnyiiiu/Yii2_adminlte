    ...
    <div class="body-content">
        <div class="row">
            <div class="col-lg-4">
                ...
                <p>互联社区，提供数位媒体服务，便捷小区居民，为数字中国添砖加瓦。我们将为您提供全方位的新体验，享受便捷生活；让美好事情在身边发生。</p>
                <p><a class="btn btn-default" href="#">浏览 &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <h2>服务</h2>
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-default" href="#">购物 &raquo;</a></p>
            </div>
        </div>
